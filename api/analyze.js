...
export default async function handler(req, res) {
  ...
  try {
    const prompt = 'You are a German language teacher checking ' + level + ' level text.\n\nAnalyze this text for errors. All explanations MUST be in Turkish only.\n\nTEXT:\n' + t + '\n\nReply ONLY with valid JSON, no markdown:\n{"corrected":"corrected text here","errors":[{"type":"gram","original":"wrong text","correction":"correct text","explanation":"Turkce aciklama"}]}\n\nType values: gram=grammar, spell=spelling, punct=punctuation, case=capitalization. Use exactly these values.';
    ...
    catch { result = { corrected: t, errors: [] }; }
